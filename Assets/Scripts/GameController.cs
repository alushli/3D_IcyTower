...
public class GameController : MonoBehaviour
{
    ...
    [SerializeField] private GameObject stepPrefab, playerObj, cameraObj, wallObj, rightBoundaryObj, leftBoundaryObj, frontBoundaryObj;
    [SerializeField] private GameObject popupObj;
    [SerializeField] private Text scoreText, timeText;

    private Player playerCom;
    private Camara cameraCom;
    ...
    void Start()
    {
        playerCom = playerObj.GetComponent<Player>();
        cameraCom = cameraObj.GetComponent<Camara>();
